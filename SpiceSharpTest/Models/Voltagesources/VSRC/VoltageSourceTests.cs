...
namespace SpiceSharpTest.Models
{
    ...
    public class VoltageSourceTests : Framework
    {
        ...
        public void When_SimpleSmallSignal_Expect_Reference()
        {
            ...
            AC ac = new AC("ac", new DecadeSweep(1.0, 100, 5));
            IExport<Complex>[] exports = new IExport<Complex>[] { new ComplexVoltageExport(ac, "in") };
            Func<double, Complex>[] references = new Func<double, Complex>[] { f => new Complex(1.0, 0.0) };
