...
namespace SpiceSharp.Components.Mosfets.Level1
{
    ...
    [BehaviorFor(typeof(Mosfet1)), AddBehaviorIfNo(typeof(ITemperatureBehavior))]
    [GeneratedParameters]
        ...
        IParameterized<Parameters>
    {
        ...
        public double SourceConductance
        {
            get
            {
                return Properties.SourceConductance.Equals(0.0) ? double.PositiveInfinity : Properties.SourceConductance;
            }
        }
        ...
        public double DrainConductance
        {
            get
            {
                return Properties.DrainConductance.Equals(0.0) ? double.PositiveInfinity : Properties.DrainConductance;
            }
        }
        ...
        public double SourceResistance
        {
            get
            {
                return Properties.SourceConductance.Equals(0.0) ? 0 : 1.0 / Properties.SourceConductance;
            }
        }
        ...
        public double DrainResistance
        {
            get
            {
                return Properties.DrainConductance.Equals(0.0) ? 0 : 1.0 / Properties.DrainConductance;
            }
        }
        ...
        public double SourceVCritical
        {
            get
            {
                return Properties.SourceVCritical;
            }
        }
        ...
        public double DrainVCritical
        {
            get
            {
                return Properties.DrainVCritical;
            }
        }
        ...
        void ITemperatureBehavior.Temperature()
        {
            ...
            else
            {
                Properties.DrainVCritical =
                        Properties.TempVt * Math.Log(Properties.TempVt / (Constants.Root2 *
            ...
            else
            {
                ...
                {
                    czbd = Properties.TempCj * Parameters.ParallelMultiplier * Parameters.DrainArea;
                }
                else
                {
                    czbd = 0;
            ...
            {
                if (ModelParameters.SheetResistance != 0)
                {
